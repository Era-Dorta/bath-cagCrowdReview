...
This type of simulation is typically used when the crowd reaches a predetermined density threshold.\\
...
Secondly, \textbf{Dynamically generated impostors} entails displaying 2D billboards instead of the full model.
...
Because this ``cloned'' models are visually undesirable, methods to infuse divergence are required to \textbf{achieve variety}. 
